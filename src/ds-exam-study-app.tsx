      ...
      <div className="min-h-screen bg-gray-50 p-4">
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-lg shadow-md p-8">
            <h2 className="text-3xl font-bold text-center mb-8">学習結果</h2>
            
            <div className="text-center mb-8">
              <div className="text-6xl font-bold text-blue-600 mb-2">{percentage}%</div>
              <div className="text-xl text-gray-600">{score} / {totalQuestions} 問正解</div>
            </div>

            <div className="space-y-4 mb-8">
              <h3 className="text-xl font-semibold mb-4">カテゴリ別成績</h3>
    ...
    return (
      <div className="min-h-screen bg-gray-50 p-4 flex items-center justify-center">
        <div className="bg-white rounded-lg shadow-md p-8 text-center">
          <h2 className="text-2xl font-bold mb-4">問題がありません</h2>
          <p className="text-gray-600 mb-4">選択した条件に該当する問題が見つかりませんでした。</p>
          <button
            onClick={() => {
              setStudyMode('all');
    ...
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          {/* 問題文 */}
          <div className="mb-6">
            <h3 className="text-lg font-semibold mb-4 whitespace-pre-line">
          ...
          {showResult && (
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="font-semibold text-blue-900 mb-1">解説</h4>
        ...
        <div className="mt-6 bg-yellow-50 border border-yellow-200 rounded-lg p-4">
          <h4 className="font-semibold text-yellow-900 mb-2">💡 学習のポイント</h4>
