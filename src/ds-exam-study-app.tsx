...
import { CheckCircle, XCircle, BookOpen, Brain, Wrench, Briefcase, RotateCcw, ChevronRight, Sun, Moon } from 'lucide-react';
        ...
        <div className={`rounded-lg shadow-md p-6 mb-6 ${isDarkMode ? 'bg-gray-800' : 'bg-white'} relative`}>
          ...
          <div className="absolute top-4 right-4 flex items-center gap-2">
            ...
            <button
              ...
              className={`p-2 rounded-md transition-colors ${isDarkMode ? 'bg-gray-700 text-yellow-400 hover:bg-gray-600' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'}`}
              title="テーマを切り替え"
            >
