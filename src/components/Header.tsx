      ...
      <div className="flex justify-between items-start mb-4">
        ...
        <div className="flex items-center gap-2">
          <a 
            ...
            className="p-2 rounded-md hover:bg-opacity-80 text-gray-600 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700 transition-colors"
            title="GitHub"
          ...
          <Expand 
            ...
            className="p-2 rounded-md hover:bg-opacity-80 text-gray-900 dark:text-white transition-colors"
